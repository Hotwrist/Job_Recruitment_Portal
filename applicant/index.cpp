...
/* The search_companies Function
	It takes one parametre: username of type string. This is displayed alongside the online notification dot.
	It provides a form where the applicant can enter his skill, to search for companies requiring his skill.
*/
void search_companies(string username)
{
	try 
	{
        	cout << HTTPHTMLHeader() << endl;
        	...
        	cout << form().set("method", "post").set("action", "company_list.cgi") << endl;
        	cout << p("Search For Companies") << endl;
